...
import { LogOut, Star, Search } from 'lucide-react'
...
const Page = () => {
    ...
    const checkExistingReview = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setAllChairReviews(data.allReviews || [])
            }
        } catch (error) {
    ...
    const handleSubmitReview = async () => {
        try {
            ...
            setAllChairReviews([newReview, ...allChairReviews])
                    ...
                    <>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        >
                                            View All Reviews ({allChairReviews.length})
                                        </Button>
                                        <Button
                                            variant="destructive"
                        ...
                        <Dialog open={showReviews} onOpenChange={setShowReviews}>
                            <DialogContent className="max-h-[70vh]">
                                ...
                                <div className="space-y-6 overflow-y-auto max-h-[calc(70vh-8rem)] pr-4">
                                    {allChairReviews.map((review) => (
                        ...
                        <Dialog open={showRatingDialog} onOpenChange={setShowRatingDialog}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    <DialogTitle>
                                        {existingReview ? 'Update Your Review' : 'Rate & Review Chair'}
                                    </DialogTitle>
                                </DialogHeader>
